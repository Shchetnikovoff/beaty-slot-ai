...
export const RouteEfficiencyTable: React.FC<RouteEfficiencyTableProps> = ({
  ...
  if (error) {
    return (
      <ErrorAlert
        title="Ошибка загрузки эффективности маршрутов"
        message={error.message || 'Не удалось загрузить данные эффективности маршрутов'}
      />
    );
  }
      ...
      <Table verticalSpacing="sm" highlightOnHover>
        <Table.Thead>
          <Table.Tr>
            ...
            <Table.Th>Ср. время</Table.Th>
            <Table.Th>Отправления</Table.Th>
