...
export const ActiveShipmentsTable: React.FC<ActiveShipmentsTableProps> = ({
  ...
  if (error) {
    return (
      <ErrorAlert
        title="Ошибка загрузки отправлений"
        message={error.message || 'Не удалось загрузить активные отправления'}
      />
    );
  }
