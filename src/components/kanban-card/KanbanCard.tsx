...
const KanbanCard = (props: Props) => {
  ...
  const confirmModal = (task: ITask) =>
    modals.openConfirmModal({
      ...
      centered: true,
      children: <Text size="sm">Эта задача будет удалена</Text>,
      labels: { confirm: 'Удалить задачу', cancel: 'Нет, не удалять' },
    ...
    >
      <Flex>
        ...
        <Menu shadow="md" position="left-start" width={200}>
          ...
          <Menu.Dropdown>
            <Tooltip label="Переименовать задачу">
              <Menu.Item
